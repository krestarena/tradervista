...
class DigitalProductController  extends Controller
{
    ...
    public function __construct(VendorVerificationService $vendorVerificationService)
    {
    ...
    public function store(ProductRequest $request)
    {
        ...
        if ($this->vendorVerificationService->ensureProductDraftForUnverified(Auth::user(), $product)) {
            flash(translate('Digital Product has been inserted successfully'))->success();
        } else {
            flash(translate('Digital product saved as draft until your KYC is approved.'))->warning();
        }

...
{
    public function __construct(protected VendorVerificationService $vendorVerificationService)
    {
    }
    ...
    public function index()
    {
        ...
        $data['latestKycSubmission'] = $this->vendorVerificationService->latestSubmissionFor(auth()->user());

                ...
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            <!-- Left Side Image-->
                            <div class="col-lg-6">
                                <img src="{{ uploaded_asset(get_setting('delivery_boy_login_page_image')) }}" alt="{{ translate('Delivery Boy Login Page Image') }}" class="img-fit h-100">
                            </div>
                            ...
                            <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content" style="height: auto;">
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form class="form-default" id="deliveryboy-login-form" role="form" action="{{ route('login') }}" method="POST">
                                            @csrf
        ...
        <script type="text/javascript">
                document.getElementById('deliveryboy-login-form').addEventListener('submit', function(e) {
                    ...
                    grecaptcha.ready(function() {
                        grecaptcha.execute(`{{ env('CAPTCHA_KEY') }}`, {action: 'deliveryboy_login'}).then(function(token) {

            ...
            <div class="row gutters-5">
                ...
                @if ($order->shipping_type === 'pickup_point')
                        ...
                        <div class="alert alert-soft-primary d-flex flex-column flex-lg-row justify-content-between align-items-start">
                            <div>
                                ...
                                <p class="mb-0 small text-muted">
                                    {{ translate('Mark orders as ready with a pickup window so buyers know when to collect and when Payment Protection releases.') }}
                                </p>
                            </div>
                    ...
                    <div class="col-md-3 mt-3">
                        ...
                        <small class="text-muted">{{ translate('Buyers must collect before this window ends.') }}</small>
                    </div>
                @endif
            </div>
            <div class="mb-3">
...
@section('script')
    <script type="text/javascript">
        ...
        $('#update_delivery_status').on('change', function() {
            ...
            $.post('{{ route('orders.update_delivery_status') }}', payload, function(data) {

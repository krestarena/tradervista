    ...
    <div class="card">
        ...
        <form action="{{ route('delivery-boys.update', $delivery_boy->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label">{{ translate('Current KYC Status') }}</label>
                    <div class="col-sm-10">
                ...
                @php $selectedCities = collect(old('service_area_cities', $dispatcherProfile->service_area_cities ?? [])); @endphp
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control aiz-selectpicker" name="service_area_cities[]" multiple data-live-search="true" required>
                            @foreach($serviceCities as $cityOption)
                                <option value="{{ $cityOption->id }}" @if($selectedCities->contains($cityOption->id)) selected @endif>
                                    {{ $cityOption->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" min="1" class="form-control" name="default_eta_hours" value="{{ old('default_eta_hours', $dispatcherProfile->default_eta_hours) }}" required>
                    </div>
                </div>

                  ...
                  <!-- Top content -->
                    ...
                    <form method="POST" action="{{ route('purchase.code') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="purchase_code" name="purchase_code" placeholder="Enter Anything Nulled by @indianvell" required>
                        </div>
                        <div class="form-group">
                            <label for="system_key" class="fs-12 fw-500" style="color: #666;">System Key</label>
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="system_key" name="system_key" placeholder="Enter Anything Nulled by @indianvell" required>

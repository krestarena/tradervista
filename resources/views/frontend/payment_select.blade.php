                                    ...
                                    <div class="py-4 px-4 bg-white border mt-4">
                                        ...
                                        @else
                                            <form method="POST" action="{{ route('checkout.voucher.apply') }}" class="form-inline">
                                                @csrf
                                                <label class="sr-only" for="voucher_amount_select">{{ translate('Voucher amount') }}</label>
                                                <input type="number" step="0.01" min="0" max="{{ $voucherContext['balance'] }}" name="amount" id="voucher_amount_select"
                                        ...
                                        @endif
                                        <small class="d-block mt-2 text-muted">{{ translate('Voucher funds are reserved until payment is confirmed.') }}</small>
                                    </div>
                                @endif

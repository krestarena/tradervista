...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function(){
    ...
    Route::controller(DeliveryBoyController::class)->group(function () {
        ...
        Route::post('/delivery-boy/{deliveryBoy}/kyc-approve', 'approveKyc')->name('delivery-boy.kyc.approve');
        Route::post('/delivery-boy/{deliveryBoy}/kyc-reject', 'rejectKyc')->name('delivery-boy.kyc.reject');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned', 'prevent-back-history']], function() {
    Route::controller(DeliveryBoyController::class)->group(function () {
        ...
        Route::post('/delivery-boy/kyc-submit', 'submitKyc')->name('delivery-boy.kyc.submit');
    });

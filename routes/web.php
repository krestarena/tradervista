...
use App\Http\Controllers\TradeVista\DisputeController as TradeVistaDisputeController;
...
Route::group(['prefix' => 'checkout'], function () {
    Route::controller(CheckoutController::class)->group(function () {
        ...
        Route::post('/voucher/apply', 'applyVoucher')->name('checkout.voucher.apply');
        Route::delete('/voucher/remove', 'removeVoucher')->name('checkout.voucher.remove');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/tradevista/orders/{order}/disputes', [TradeVistaDisputeController::class, 'store'])->name('tradevista.disputes.store');
    // Reviews

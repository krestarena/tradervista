...
return [
    ...
    'own_dispatch_immediate_payout' => env('TRADEVISTA_OWN_DISPATCH_IMMEDIATE_PAYOUT', true),
    'payment_protection_badge_enabled' => env('TRADEVISTA_PAYMENT_PROTECTION_BADGE_ENABLED', true),
    ...
    'audit_logging_enabled' => env('TRADEVISTA_AUDIT_LOGGING_ENABLED', true),
    ...
    'referral' => [
        ...
        'enable_buyer_rewards' => env('TRADEVISTA_ENABLE_BUYER_REFERRAL_REWARDS', true),
        'enable_seller_rewards' => env('TRADEVISTA_ENABLE_SELLER_REFERRAL_REWARDS', true),
    ],
    'kyc' => [
        'vendor_required' => env('TRADEVISTA_KYC_VENDOR_REQUIRED', true),
        ...
        'admin_approval_required' => env('TRADEVISTA_KYC_ADMIN_APPROVAL_REQUIRED', true),
    ],
    'commission' => [
        'category_matrix_enabled' => env('TRADEVISTA_COMMISSION_CATEGORY_MATRIX_ENABLED', true),
    ...
    'vouchers' => [
        'checkout_usage_enabled' => env('TRADEVISTA_VOUCHER_CHECKOUT_USAGE_ENABLED', true),
        'voucher_history_notifications' => env('TRADEVISTA_VOUCHER_HISTORY_NOTIFICATIONS', true),
        'merchant_portal_statements' => env('TRADEVISTA_VOUCHER_MERCHANT_STATEMENTS', false),
    ],
    'disputes' => [
        'evidence_upload_enabled' => env('TRADEVISTA_DISPUTE_EVIDENCE_UPLOAD_ENABLED', true),
        'timeline_notes_enabled' => env('TRADEVISTA_DISPUTE_TIMELINE_NOTES_ENABLED', true),
    ],
];
